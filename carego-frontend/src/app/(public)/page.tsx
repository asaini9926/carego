...
async function getPublicData() {
  try {
    ...
    const [citiesRes, servicesRes] = await Promise.all([
      fetch("http://localhost:5000/api/v1/public/cities", {
        next: { revalidate: 3600 },
      }),
      fetch("http://localhost:5000/api/v1/public/services", {
        next: { revalidate: 3600 },
      }),
    ]);
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-lg text-gray-600 mb-8 max-w-lg mx-auto md:mx-0">
                Don't stress about post-surgery recovery or elderly care. We
                provide verified, police-checked staff within 2 hours.
              </p>
